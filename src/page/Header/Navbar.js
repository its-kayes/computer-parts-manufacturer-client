...
//                                     user
//                                     ?
//                                         <CustomLink to='/additemtodb' className="block py-2 pr-4 pl-3 text-rose-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Add Item</CustomLink>
//                                         :
...
//                                     user
//                                         ?
//                                         <CustomLink onClick={signout} className="block py-2 pr-4 pl-3 text-rose-100 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" to='/login'> Sign Out </CustomLink>
//                                         :
//                                         <CustomLink className="block py-2 pr-4 pl-3 text-rose-100 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" to='/login'> Login </CustomLink>
//                                 }
//                             </li>
