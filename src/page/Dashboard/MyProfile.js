            ...
            <div>
                <div class="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <p className='font-semibold'> {newProfile?.profession} </p>
                        <p> {newProfile?.about} </p>
                ...
                <div class="p-4 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className='flex justify-around font-mono'>
                        <div>
                            ...
                            <p className=' mt-3 pt-4'> Gender: {newProfile?.gender} </p>
                            <p className=' mt-3 pt-4'> Address: {newProfile?.address} </p>
                        </div>
                        <div>
                            <p className=' mt-3 pt-4'> Education: {newProfile?.education} </p>
                            <p className=' mt-3 pt-4'> Number: {newProfile?.number}  </p>
                    ...
                    <div>
                        <label for="profile" class="btn modal-button w-full max-w-xs ">Update Profile</label>
                        ...
                        <div class="modal modal-bottom sm:modal-middle">
                            <form onSubmit={updateProfile} className="modal-box">
                                ...
                                <div class="relative z-0 w-full mb-6 group border-2">
                                    <label htmlFor="number" className='underline'> Phone Number </label>
                                    <input type="number" name="number" id="number" className='block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer' />
                                </div>
